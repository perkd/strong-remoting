...
class HttpClient {
  ...
  get axios() {
    if (!this._axiosInstance) {
      try {
        ...
        // Create axios instance with connection management
  ...
  destroy() {
    if (this._axiosInstance) {
      ...
      if (this._axiosInstance.defaults.httpAgent) {
        this._axiosInstance.defaults.httpAgent.destroy();
      }
      if (this._axiosInstance.defaults.httpsAgent) {
        this._axiosInstance.defaults.httpsAgent.destroy();
      }
      this._axiosInstance = null;
    }
    this._axios = null;
