...
HttpContext.prototype.respondWithEventStream = function(stream) {
  ...
  // Initialize the SSE client asynchronously
  client.initialize().catch(err => {
    // If initialization fails, the client will fall back to manual mode
    console.warn('SSE client initialization failed, using fallback mode:', err.message);
  });
